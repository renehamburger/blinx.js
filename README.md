...
```html
<script src="https://cdn.rawgit.com/renehamburger/blinx.js/v0.3.11/dist/blinx.js" defer data-blinx="{
  language: 'de'
}"></script>
```
...
<script src="https://cdn.rawgit.com/renehamburger/blinx.js/v0.3.11/dist/blinx.js" defer></script>
```
...
blinxScript.src = 'https://cdn.rawgit.com/renehamburger/blinx.js/v0.3.11/dist/blinx.js';
