...
```html
<script src="https://cdn.rawgit.com/renehamburger/blinx.js/v0.1.1/dist/blinx.js" defer data-blinx="{
  language: 'de'
}"></script>
```
...
<script src="https://cdn.rawgit.com/renehamburger/blinx.js/v0.1.1/dist/blinx.js" defer></script>
```
...
blinxScript.src = 'https://cdn.rawgit.com/renehamburger/blinx.js/v0.1.1/dist/blinx.js';
