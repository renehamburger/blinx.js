...
```html
<script
  src="https://cdn.jsdelivr.net/gh/renehamburger/blinx.js@v0.5.4/dist/blinx.js"
  defer
  data-blinx="{
  language: 'de'
}"
...
blinxScript.src = 'https://cdn.jsdelivr.net/gh/renehamburger/blinx.js@v0.5.4/dist/blinx.js';
